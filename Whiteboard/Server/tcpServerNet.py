...
class MyServer(QTcpServer):
    def __init__(self, parent = None):
        ...
        self.data_update = Signal(list)
        self.client_socket = None 
        self.timer = None 
        self.clinet_address = None 


    def incomingConnection(self, socket_description):
        print('yes\n')
        self.client_socket = QTcpSocket()
        self.client_socket.setSocketDescriptor(socket_description)
        ...
        self.clinet_address = self.client_socket.peerAddress().toString()
        print(f'Client connected form {self.clinet_address}')
